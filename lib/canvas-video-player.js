...
module.exports = function (options) {
  ...
  this.bind = function () {
    this.canvas.addEventListener('click', self.cvpHandlers.canvasClickHandler = function () {
      /*self.playPause();*/
    });
    this.video.addEventListener('timeupdate', self.cvpHandlers.videoTimeUpdateHandler = function () {
      self.drawFrame();
    ...
    this.video.addEventListener('canplay', self.cvpHandlers.videoCanPlayHandler = function () {
      self.drawFrame();
    });
    ...
    window.addEventListener('resize', self.cvpHandlers.windowResizeHandler = function () {
    ...
    this.play = function () {
      ...
      if (this.options.audio) {
        ...
        try {
          ...
          (_this$audio = this.audio) === null || _this$audio === void 0 ? void 0 : _this$audio.play();
        } catch (_unused) {
    ...
    this.playPause = function () {
      if (this.playing) this.pause();else this === null || this === void 0 ? void 0 : this.play();
    };
    ...
    this.loop = function (argument) {
      ...
      if (this.video.currentTime >= this.video.duration) {
        ...
        if (this.options.loop === true) {
          ...
          this === null || this === void 0 ? void 0 : this.play();
        }
      }
    ...
    if (self.options.autoplay) {
      self === null || self === void 0 ? void 0 : self.play();
    }
  };
