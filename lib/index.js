...
var playsinline_player = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(playsinline_player, [{
    ...
    value: function componentWillUnmount() {
      var _this$video, _this$video$unbind, _this$video2, _this$video2$removeEv;

      clearInterval(this.interval);
      (_this$video = this.video) === null || _this$video === void 0 ? void 0 : (_this$video$unbind = _this$video.unbind) === null || _this$video$unbind === void 0 ? void 0 : _this$video$unbind.call(_this$video);
      var _this$props$onend = this.props.onend,
          onend = _this$props$onend === void 0 ? function () {} : _this$props$onend;
      (_this$video2 = this.video) === null || _this$video2 === void 0 ? void 0 : (_this$video2$removeEv = _this$video2.removeEventListener) === null || _this$video2$removeEv === void 0 ? void 0 : _this$video2$removeEv.call(_this$video2, 'ended', onend);
    }
  }, {
    key: "setURL",
    value: function setURL(u) {
      ...
      source.map(function (e) {
        if (e.type === 'video/mp4') {
          ...
          video.load();
          if (!_lescaUserAgent["default"].Ios.is()) video.play();
        }
      });
    }
  }, {
    ...
    value: function add_video_player() {
      ...
      var _this$props$onend2 = this.props.onend,
          onend = _this$props$onend2 === void 0 ? function () {} : _this$props$onend2;
      this.video.removeEventListener('ended', onend);
      this.video.addEventListener('ended', onend); //this.video.onended = this.props.onend || function () {};
    }
  }, {
