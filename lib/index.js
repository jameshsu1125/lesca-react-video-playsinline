  ...
  _createClass(playsinline_player, [{
    ...
    value: function componentDidMount() {
      ...
      this.timer = setInterval(function () {
        if (_this.refs.video.readyState == 4) {
          if (_this.props.ready) _this.props.ready();
    ...
    value: function add_video_player() {
      ...
      if (this.props.onupdate) {
        this.interval = setInterval(function () {
          _this2.props.onupdate(_this2.video.currentTime, _this2.video.duration, _this2.video.readyState);
        }, 10);
      }
